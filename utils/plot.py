...
def curve(train: list, val: list, title: str, y_label: str, filePath, nt) -> None:
    """
    绘制损失值和准确率曲线
    ...
    # plt.show()
    plt.savefig(filePath + r'/_{}.jpg'.format(title))
...
def waveform(file_path: str, id, age) -> None:
    """
    绘制音频波形图
    ...
    plt.savefig(r'./waveImg/{}_{}.jpg'.format(id, age))
